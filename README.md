...
![Pedestrian network raster layer.](cbdped.bmp =250x250)
...
![Nodes identified and indexed.]("Map of node labels.png" =250x250)
...
![Example catchment output.](example_catchment_output.bmp =250x250)
